  ...
  void print() {
    ...
    for (int i = 0; i < row; i++) {
      for (int j = 0; j < column; j++) {
        ...
        if (i == 0 && j > 0 && j < 11) System.out.print(" ");
      }
      System.out.println();
    }
  }
